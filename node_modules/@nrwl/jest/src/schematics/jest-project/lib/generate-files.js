...
function generateFiles(options) {
    return (tree, _context) => {
        ...
        return schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign(Object.assign({ tmpl: '' }, options), { transformer: options.babelJest ? 'babel-jest' : 'ts-jest', projectRoot: projectConfig.root, offsetFromRoot: devkit_1.offsetFromRoot(projectConfig.root) })),
