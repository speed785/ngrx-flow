    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (migrations.length > 0) {
                ...
                logger_1.logger.info(`- Run 'nx migrate --run-migrations=migrations.json'`);
            }
            else {
                logger_1.logger.info(`NX The migrate command has run successfully.`);
                logger_1.logger.info(`- package.json has been updated`);
            ...
            logger_1.logger.error(`NX The migrate command failed. Try the following to migrate your workspace:`);
            logger_1.logger.error(`> npx @nrwl/tao@latest migrate ${opts.targetPackage}@${opts.targetVersion}`);
            logger_1.logger.error(`This will use the newest version of the migrate functionality, which might have your issue resolved.`);
