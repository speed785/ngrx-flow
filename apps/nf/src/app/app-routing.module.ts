...
export const routes: Routes = [
    ...
    {
        path: 'films',
        loadChildren: () => import('@ngrx-flow/films').then(mod => mod.FilmsModule)
    },
    {
        path: 'vehicles',
        loadChildren: () => import('@ngrx-flow/vehicles').then(mod => mod.VehiclesModule)
    },
    {
        path: 'species',
        loadChildren: () => import('@ngrx-flow/species').then(mod => mod.SpeciesModule)
    },
    {
        path: 'starships',
